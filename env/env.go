...
// TODO: time, time_duration, SLICE Of of xyz, map of xy, pointers
//// GetEnvAsSliceOrFallback returns the env variable for the given key,
//// parses it as boolean and falls back to the given defaultValue if not set
//func GetEnvAsSliceOrFallback(key string, defaultValue bool) bool {
//	if v := os.Getenv(key); v != "" {
//		val, err := strconv.ParseBool(v)
//		if err != nil {
//			return defaultValue
